...
var ImportSpecifier = function (_ModuleSpecifier) {
    (0, _inherits3.default)(ImportSpecifier, _ModuleSpecifier);

    function ImportSpecifier(childNodes) {
    ...
    (0, _createClass3.default)(ImportSpecifier, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            var local = void 0;
            var imported = children.passNode('Identifier');
