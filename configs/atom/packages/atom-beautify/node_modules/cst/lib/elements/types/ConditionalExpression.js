...
var ConditionalExpression = function (_Expression) {
    (0, _inherits3.default)(ConditionalExpression, _Expression);


    // TODO: Should respect operator precedence: putting "a + b" before " * b" without parens should raise an error.

    function ConditionalExpression(childNodes) {
    ...
    (0, _createClass3.default)(ConditionalExpression, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            ...
            var consequent = children.passExpression();
            children.skipNonCode();

            children.passToken('Punctuator', ':');
            children.skipNonCode();

            var alternate = children.passExpression();
            children.assertEnd();
