...
var ExportAllDeclaration = function (_ModuleDeclaration) {
    (0, _inherits3.default)(ExportAllDeclaration, _ModuleDeclaration);

    function ExportAllDeclaration(childNodes) {
    ...
    (0, _createClass3.default)(ExportAllDeclaration, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            ...
            children.skipNonCode();
            var source = children.passNode('StringLiteral');
            if (!children.isEnd) {
                children.skipNonCode();
                children.passToken('Punctuator', ';');
            }
...
//# sourceMappingURL=ExportAllDeclaration.js.map