...
var ThrowStatement = function (_Statement) {
    (0, _inherits3.default)(ThrowStatement, _Statement);

    function ThrowStatement(childNodes) {
    ...
    (0, _createClass3.default)(ThrowStatement, [{
        key: '_acceptChildren',
