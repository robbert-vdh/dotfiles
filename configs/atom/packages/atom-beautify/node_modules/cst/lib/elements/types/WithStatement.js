...
var WithStatement = function (_Statement) {
    (0, _inherits3.default)(WithStatement, _Statement);

    function WithStatement(childNodes) {
    ...
    (0, _createClass3.default)(WithStatement, [{
        key: '_acceptChildren',
        value: function _acceptChildren(children) {
            ...
            var object = children.passExpression();
            children.skipNonCode();
