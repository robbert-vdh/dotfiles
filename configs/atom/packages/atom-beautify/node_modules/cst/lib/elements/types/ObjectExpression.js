...
var ObjectExpression = function (_Expression) {
    (0, _inherits3.default)(ObjectExpression, _Expression);

    function ObjectExpression(childNodes) {
    ...
    (0, _createClass3.default)(ObjectExpression, [{
        key: '_acceptChildren',
