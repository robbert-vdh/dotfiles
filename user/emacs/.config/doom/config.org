...
;; The formatter included with hls is not very good and it strips haddock
;; comments
;; TODO: Remove once haskell-language-server's Brittany plugin works again
(setq-hook! 'haskell-mode-hook +format-with-lsp nil)

(after! lsp-mode
  ;; FIXME: `lsp-register-custom-settings` does not seem to work
  ;; TODO: hlint is not actually implemented yet
  (defvar +robbert/lsp-haskell-use-hlint t)
  ;; TODO: Brittany does not support GHC 8.10 yet
  (defvar +robbert/lsp-haskell-formatter "brittany")
  (lsp-register-custom-settings
   `(("haskell.hlintOn" +robbert/lsp-haskell-use-hlint t)
     ("haskell.formattingProvider" +robbert/lsp-haskell-formatter))))

(after! lsp-haskell
  ;; TODO: Remove after hlint gets added to haskell-language-server
