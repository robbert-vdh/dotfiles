...
(after! haskell-mode
  ...
  (add-hook 'haskell-ts-mode-hook #'haskell-decl-scan-mode)
  (add-hook 'haskell-ts-mode-hook #'haskell-indentation-mode)
  (setq-hook! 'haskell-ts-mode-hook
    outline-regexp "-- \\*+"
  ...
  ;; while now
  (set-next-checker! 'haskell-ts-mode 'lsp 'haskell-hlint)
  (unless (member 'haskell-ts-mode (flycheck-checker-get 'haskell-hlint 'modes))
    (push 'haskell-ts-mode (flycheck-checker-get 'haskell-hlint 'modes)))
...
#+begin_src emacs-lisp
(setq-hook! 'haskell-ts-mode-hook lsp-semantic-tokens-enable nil)
#+end_src
...
#+begin_src emacs-lisp
(after! markdown-mode
  (add-hook 'markdown-ts-mode-hook #'doom-disable-delete-trailing-whitespace-h))
#+end_src
